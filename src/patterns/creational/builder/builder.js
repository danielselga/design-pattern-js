/**
 * BUILDER PATTERN -> When picewise object constructuion is complicated, provide an API for doing it succintly.
 * Some objects are simple and can be created in a single initializaer call.
 * Other objects require a lot of ceremony to create.
 * Having an object with 10 initializers arguments is not productive.
 * Instead, opt for picewise construction.
